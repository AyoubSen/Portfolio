<template>
  <div class="contact-icons">
    <div class="contact-icon" @click="openGithub">
      <svg
        width="40px"
        height="40px"
        viewBox="0 0 20 20"
    ...
    <div class="contact-icon" @click="openLinkedIn">
      <svg
        :fill="colorMode.value === 'light' ? '#333' : 'white'"
        height="41px"
        width="41px"
        version="1.1"
        id="Layer_1"
...
const openGithub = () => {
  window.open("https://github.com/AyoubSen");
};

const openLinkedIn = () => {
  window.open("https://www.linkedin.com/in/ayoub-senhaji/");
};
</script>
